...
$(document).ready(function(){
	...
	$(".email_address2_act").click (function () {
     if (!ValidateEmail($("#mail").val()))  {
         $('.checkout_error').show().html("Enter mail address");
          }
        else if ($("#password").val()=="") {
			$('.checkout_error').show().html("Enter password");
			}
        else {
        	$('.email_addres_2').hide();
        	$('.checkout_error').hide();
			...
			$('.chckout_yourinfo').show(function(){
				var ma=$("#mail").val();
				$("#email").val(ma);
			});}
 	});	
	$(".email_address3_act").click (function () {
		if ($("#fname_p").val()=="") {
			$('.checkout_error').show().html("Enter name");
			}
    	else if (!ValidateEmail($("#email_p").val()))  {
         $('.checkout_error').show().html("Enter mail address");
          }
        else if ($("#register-form-username").val()=="") {
			$('.checkout_error').show().html("Enter user name");
			}
		else if ($("#phone_number_p").val()=="") {
			$('.checkout_error').show().html("Enter phone");
			}
		else if ($("#register-form-password").val()=="") {
			$('.checkout_error').show().html("Enter password");
			}
		else if ($("#register-form-repassword").val()=="") {
			$('.checkout_error').show().html("Reenter password");
			}
        else {
        	$('.email_addres_2').hide();
        	$('.checkout_error').hide();
...
$(".yourinfo_act").click (function () {
		...
		var zip = $("#zip").val();
	 	var chk = $ ("#ship_add")
			...
			{
			$("#firstname").focus();
 			$('.checkout_error').show().html("Enter firstname");
 			return false;
			}
		else if($("#lastname").val()=="")
			{
			$("#lastname").focus();
 			$('.checkout_error').show().html("Enter lastname");
 			return false;
			}
		else if($("#phone").val()=="")
			{
			...
			{
			$("#address1").focus();
 			$('.checkout_error').show().html("Enter address");
 			return false;
			}
			...
			{
 			$('.checkout_error').show().html("select country1");
 			return false;
			}
			...
			{
			$("#city").focus();
 			$('.checkout_error').show().html("select city");
 			return false;
			}
		else if($("#zip").val()=="")
			{
			$("#zip").focus();
 			$('.checkout_error').show().html("select zip");
 			return false;
			}
		else if(chk.is(':checked'))
			{
    			...
    			$('.checkout_error').hide();
			$('.newcheck_out_shipping').show();
			$('.shipping_same_address_act').hide();
			$('.checkout_4_act').addClass('selected');
			...
			$("#lastname1").focus();
				...
				{
				$("#phone1").focus();
	 			$('.checkout_error').show().html("enter phoen");
	 			return false;
				}
			else if($("#address11").val()=="")
				{
				$("#address11").focus();
	 			$('.checkout_error').show().html("enter address");
	 			return false;
		 		}
		 	else if($("#address21").val()=="")
		 		{
				$("#address21").focus();
	  			$('.checkout_error').show().html("enter address");
	 			return false;
			...
			else if($("#country3").val()=="Please Select")
				{
			$("#country3").focus();
	 			$('.checkout_error').show().html("select country");
	 			return false;
				}
			else if($("#country4").val()=="Please Select")
				{
	 		$("#country4").focus();
	 			$('.checkout_error').show().html("select country");
	 			return false;
		 		...
		 		{
				$("#city1").focus();
	  			$('.checkout_error').show().html("enter city");
	 			return false;
				}
			else if($("#zip1").val()=="")
				{
	 		$("#zip1").focus();
	 			$('.checkout_error').show().html("enter zip");
	 			return false;
	 		}
		...
		$('.payment_holder_act').click(function(){
			if($("#nameoncard").val()=="")
			{
			$("#nameoncard").focus();
 			$('.checkout_error').show().html("Enter card name");
 			return false;
			}
			else if($("#cardnumber").val()=="")
			{
			$("#cardnumber").focus();
 			$('.checkout_error').show().html("Enter card Number");
 			return false;
			}
			else if($("#month").val()=="")
			{
			$("#month").focus();
 			$('.checkout_error').show().html("Choose monnth");
 			return false;
			}
			else if($("#year").val()=="")
			{
			$("#year").focus();
 			$('.checkout_error').show().html("Choose year");
 			return false;
			}
			else if($("#security_number").val()=="")
			{
			$("#security_number").focus();
 			$('.checkout_error').show().html("Choose security number");
 			return false;
			}
			else
			{
			$('.checkout_content').addClass('thank_check_out_content')
			$('.payment_holder').hide();
			$('.chckout_tkstitle').show();
			$('.checkout_error').hide();
			$('.payment_process_holder').hide();
			$('#new_check_out_cart').hide();
			$('.thankyou').show();	
			}
		});
...
// 	});
/******************** Quantity Minus / Plus in Single Description *********************/
$(function () {
...
$('.expand_filter').click(function() {
	$('.filter_list_expand').slideToggle(500);				
});
...
//************* New CheckoutPage
		...
		$(document).ready(function() {
			$('.checking').change(function() {
				if ($('.checking:checked').length) {
					$('.chk_delete_btn').removeAttr('disabled');
				} else {
					$('.chk_delete_btn').attr('disabled', 'disabled');
				}
			});
		});
	...
	$('.cmplte_purchse_act').click(function() {
		$('.chckout_title_act').css('display', 'none');
		$('.checkout_your_shoppingcart').css('display', 'none');
		$('.payment_process_holder').css('width', '100%');
		$('.checkout_form').css('width', '694px');
		...
		$('.need_help_bar').hide();
		$('.thankyou').show();
		$('.payment_process_holder').addClass("nb");
...
$('.email_address input').click (function() {
	$('.email_address').hide();
	$('.email_addres_2').show();
	$(".tipsy").hide();
...
// 	});
 // $('.yourinfo_act').click(function(){
	// $('.chckout_yourinfo').hide();
	// $('.chckout_internatinal_acc').show();
	// $('.shipping_same_address_act').hide();
	// });
// $('.chckout_intl_act').click(function(){
// 	$('.chckout_internatinal_acc').hide();
// 	$('.newcheck_out_shipping').show();
// 	$('.checkout_pathway ul li a').removeClass('selected');
// 	$('.checkout_pathway ul li a.checkout_2_act').addClass('selected');
// 	});
// $('.newcheck_out_shipping_act').click(function(){
// 	$('.newcheck_out_shipping').hide();
// 	$('.intrntional_shipping').show();
// 	});
$('.intrntional_shipping_act').click(function(){
	$('.newcheck_out_shipping').hide();
	$('.payment_holder').show();
	$('.checkout_5_act').addClass('selected');
	$('.checkout_4_act').removeClass('selected');
	});
// $('.payment_holder_act').click(function(){
// 		$('.checkout_content').addClass('thank_check_out_content')
// 		$('.payment_holder').hide();
...
var slide_desc_ele = true;	
    ...
    $('.brand_info_close').click(function() {
				$('.brand_information_view').slideUp(500);
				$('.brand_info_close').hide(); 
				}); 				
	

	var slide_ele = true;	
	$('.show_drop_down_act').click(function() {
	...
	$('.custom_dropdown ul').find('li').click(function() {
